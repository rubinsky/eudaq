...
namespace eudaq {
  ...
  void FileWriterNative::StartRun( const std::string & name, unsigned int runnumber, std::shared_ptr<JSON> config )
  {
	m_name = name;
...
/* book for the run header as JSON string: very useful thing
